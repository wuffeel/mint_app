...
import '../assembly/entity/chat_user_data_from_map.dart' as _i9;
import '../assembly/entity/specialist_model_from_dto.dart' as _i52;
import '../assembly/entity/user_model_from_dto.dart' as _i51;
import '../assembly/entity/user_presence_from_dto.dart' as _i12;
import '../assembly/factory.dart' as _i13;
import '../assembly/model/specialist_model_to_dto.dart' as _i21;
import '../assembly/model/user_model_dto_to_chat_user.dart' as _i18;
import '../assembly/model/user_model_to_dto.dart' as _i16;
...
import '../data/model/specialist_model_dto/specialist_model_dto.dart' as _i19;
import '../data/model/user_model_dto/user_model_dto.dart' as _i14;
import '../data/model/user_presence_dto/user_presence_dto.dart' as _i11;
...
import '../domain/entity/specialist_model/specialist_model.dart' as _i20;
import '../domain/entity/user_model/user_model.dart' as _i15;
import '../domain/entity/user_presence/user_presence.dart' as _i10;
...
import '../domain/use_case/fetch_chat_room_use_case.dart' as _i23;
import '../domain/use_case/fetch_unread_messages_count_use_case.dart' as _i24;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i7.Factory<_i8.User, Map<String, dynamic>>>(
        () => _i9.ChatUserDataFromMap());
    gh.factory<_i7.Factory<_i10.UserPresence, _i11.UserPresenceDto>>(
        () => _i12.UserPresenceFromDto());
    gh.factory<_i13.Factory<_i14.UserModelDto, _i15.UserModel>>(
      () => _i16.UserModelToDto(),
      registerFor: {_web},
    );
    gh.factory<_i7.Factory<_i8.User, _i17.UserModelDto>>(
        () => _i18.UserModelDtoToChatUserMap());
    gh.factory<_i13.Factory<_i19.SpecialistModelDto, _i20.SpecialistModel>>(
        () => _i21.SpecialistModelToDto());
    gh.factory<_i7.Factory<Map<String, dynamic>, _i17.UserModelDto>>(
        () => _i22.ModifiedUserDtoToMap());
    gh.factory<_i13.Factory<_i14.UserModelDto, _i15.UserModel>>(
      () => _i16.PatientUserToDto(),
      registerFor: {_native},
    );
    gh.factory<_i23.FetchChatRoomUseCase>(
        () => _i23.FetchChatRoomUseCase(gh<_i4.ChatService>()));
    gh.factory<_i24.FetchUnreadMessagesCountUseCase>(
        () => _i24.FetchUnreadMessagesCountUseCase(gh<_i4.ChatService>()));
    ...
    gh.lazySingleton<_i33.FirebaseUserRepository>(
      () => _i33.FirebaseWebUserRepository(
        ...
        gh<_i7.Factory<Map<String, dynamic>, _i17.UserModelDto>>(),
      ),
      registerFor: {_web},
    );
    gh.lazySingleton<_i33.FirebaseUserRepository>(
    ...
    gh.lazySingleton<_i47.UserController<_i15.PatientUser?>>(
      () => _i47.UserControllerNative(),
      registerFor: {_native},
    );
    gh.lazySingleton<_i47.UserController<_i15.UserModel?>>(
    ...
    gh.factory<_i50.ChatBloc<_i17.UserModel?>>(() => _i50.ChatBlocBasic(
          gh<_i47.UserController<_i17.UserModel?>>(),
    ...
    gh.factory<_i50.ChatBlocPatient>(
      () => _i50.ChatBlocPatient(
        gh<_i47.UserController<_i17.PatientUser?>>(),
        gh<_i35.GetMessagesUseCase>(),
        gh<_i5.CreateChatRoomUseCase>(),
        gh<_i44.SendMessageUseCase>(),
        gh<_i6.DeleteMessageUseCase>(),
    ...
    gh.factory<_i13.Factory<_i2.Future<_i15.UserModel>, _i14.UserModelDto>>(
      () => _i51.PatientUserFromDto(gh<_i46.StorageService>()),
      registerFor: {_native},
    );
    gh.factory<
            _i13.Factory<_i2.Future<_i20.SpecialistModel>,
    ...
    gh.factory<_i56.FirebaseUserService>(() => _i56.FirebaseUserService(
          ...
          gh<_i34.StorageService>(),
          gh<_i7.Factory<_i2.Future<_i17.UserModel>, _i17.UserModelDto>>(),
          gh<_i7.Factory<_i17.UserModelDto, _i17.UserModel>>(),
          gh<_i7.Factory<_i17.UserPresence, _i11.UserPresenceDto>>(),
        ));
