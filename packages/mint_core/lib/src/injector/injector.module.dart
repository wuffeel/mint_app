...
import '../../mint_assembly.dart' as _i19;
import '../../mint_bloc.dart' as _i68;
import '../../mint_core.dart' as _i20;
import '../../mint_module.dart' as _i33;
import '../assembly/entity/chat_user_data_from_map.dart' as _i28;
import '../assembly/entity/notification_model_from_dto.dart' as _i31;
import '../assembly/entity/specialist_model_from_dto.dart' as _i70;
import '../assembly/entity/specialist_work_info_from_dto.dart' as _i22;
import '../assembly/entity/user_model_from_dto.dart' as _i69;
import '../assembly/entity/user_presence_from_dto.dart' as _i27;
import '../assembly/factory.dart' as _i12;
import '../assembly/model/specialist_model_to_dto.dart' as _i15;
import '../assembly/model/user_model_dto_to_chat_user.dart' as _i24;
import '../assembly/model/user_model_to_dto.dart' as _i18;
import '../assembly/modified_user_dto_to_map.dart' as _i21;
...
import '../data/model/user_presence_dto/user_presence_dto.dart' as _i26;
...
import '../data/repository/file_repository_native.dart' as _i73;
import '../data/repository/file_repository_web.dart' as _i72;
...
import '../domain/entity/user_presence/user_presence.dart' as _i25;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i12.Factory<_i16.UserModelDto, _i17.UserModel>>(
      () => _i18.PatientUserToDto(),
      registerFor: {_native},
    );
    gh.factory<_i19.Factory<Map<String, dynamic>, _i20.UserModelDto>>(
        () => _i21.ModifiedUserDtoToMap());
    gh.factory<
            _i19.Factory<_i20.SpecialistWorkInfo, _i20.SpecialistWorkInfoDto>>(
        () => _i22.SpecialistWorkInfoFromDto());
    gh.factory<_i12.Factory<_i16.UserModelDto, _i17.UserModel>>(
      () => _i18.UserModelToDto(),
      registerFor: {_web},
    );
    gh.factory<_i19.Factory<_i23.User, _i20.UserModelDto>>(
        () => _i24.UserModelDtoToChatUserMap());
    gh.factory<_i19.Factory<_i25.UserPresence, _i26.UserPresenceDto>>(
        () => _i27.UserPresenceFromDto());
    gh.factory<_i19.Factory<_i23.User, Map<String, dynamic>>>(
        () => _i28.ChatUserDataFromMap());
    gh.factory<_i19.Factory<_i29.NotificationModel, _i30.NotificationModelDto>>(
    ...
    gh.factory<_i37.FirebaseAppNotificationService>(() =>
        _i37.FirebaseAppNotificationService(
          ...
          gh<_i19.Factory<_i29.NotificationModel, _i30.NotificationModelDto>>(),
        ));
    ...
    gh.lazySingleton<_i44.FirebaseUserRepository>(
      () => _i44.FirebaseNativeUserRepository(
        ...
        gh<_i19.Factory<Map<String, dynamic>, _i20.UserModelDto>>(),
      ),
      registerFor: {_native},
    );
    gh.lazySingleton<_i44.FirebaseUserRepository>(
    ...
    gh.factory<_i65.AppNotificationsBloc<_i20.UserModel?>>(
        () => _i65.AppNotificationsBlocBase(
              ...
              gh<_i62.UserController<_i20.UserModel?>>(),
            ));
    gh.factory<_i66.ChatBloc<_i20.UserModel?>>(() => _i66.ChatBlocBasic(
          gh<_i62.UserController<_i20.UserModel?>>(),
    ...
    gh.factory<_i66.ChatBlocPatient>(
      () => _i66.ChatBlocPatient(
        gh<_i62.UserController<_i20.PatientUser?>>(),
        gh<_i47.GetMessagesUseCase>(),
        gh<_i10.CreateChatRoomUseCase>(),
        gh<_i57.SendMessageUseCase>(),
        gh<_i11.DeleteMessageUseCase>(),
    ...
    gh.factory<_i67.ChatRoomBloc<_i20.UserModel?>>(() => _i67.ChatRoomBlocBasic(
          gh<_i32.FetchChatRoomListUseCase>(),
          gh<_i68.UserController<_i20.UserModel?>>(),
        ));
    gh.factory<_i67.ChatRoomBlocPatient>(
      () => _i67.ChatRoomBlocPatient(
        gh<_i32.FetchChatRoomListUseCase>(),
        gh<_i68.UserController<_i20.PatientUser?>>(),
      ),
      registerFor: {_native},
    );
    gh.factory<_i12.Factory<_i2.Future<_i17.UserModel>, _i16.UserModelDto>>(
      () => _i69.PatientUserFromDto(gh<_i60.StorageService>()),
      registerFor: {_native},
    );
    gh.factory<
            _i12.Factory<_i2.Future<_i14.SpecialistModel>,
                _i13.SpecialistModelDto>>(
        () => _i70.SpecialistModelFromDto(gh<_i60.StorageService>()));
    gh.factory<_i12.Factory<_i2.Future<_i17.UserModel>, _i16.UserModelDto>>(
      () => _i69.UserModelFromDto(gh<_i60.StorageService>()),
      registerFor: {_web},
    );
    gh.lazySingleton<_i71.FileRepository>(
      () => _i72.FileRepositoryWeb(gh<_i33.FirebaseInitializer>()),
      registerFor: {_web},
    );
    gh.lazySingleton<_i71.FileRepository>(
      () => _i73.FileRepositoryNative(gh<_i33.FirebaseInitializer>()),
      registerFor: {_native},
    );
    ...
    gh.lazySingleton<_i77.FirebaseChatRepository>(
        () => _i77.FirebaseChatRepository(
              gh<_i33.FirebaseInitializer>(),
              gh<_i19.Factory<_i23.User, Map<String, dynamic>>>(),
            ));
    ...
    gh.factory<_i80.FirebaseUserService>(() => _i80.FirebaseUserService(
          ...
          gh<_i33.StorageService>(),
          gh<_i19.Factory<_i2.Future<_i20.UserModel>, _i20.UserModelDto>>(),
          gh<_i19.Factory<_i20.UserModelDto, _i20.UserModel>>(),
          gh<_i19.Factory<_i20.UserPresence, _i26.UserPresenceDto>>(),
        ));
