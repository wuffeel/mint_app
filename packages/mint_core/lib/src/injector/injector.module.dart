...
import '../../mint_assembly.dart' as _i15;
import '../../mint_bloc.dart' as _i70;
import '../../mint_core.dart' as _i16;
import '../../mint_module.dart' as _i32;
import '../assembly/entity/chat_user_data_from_map.dart' as _i19;
import '../assembly/entity/notification_model_from_dto.dart' as _i26;
import '../assembly/entity/specialist_model_from_dto.dart' as _i71;
import '../assembly/entity/specialist_work_info_from_dto.dart' as _i17;
import '../assembly/entity/user_model_from_dto.dart' as _i72;
...
import '../assembly/model/user_model_to_dto.dart' as _i14;
...
import '../data/model/specialist_work_info_dto/specialist_work_info_dto.dart'
    as _i43;
import '../data/model/user_model_dto/user_model_dto.dart' as _i12;
...
import '../data/repository/file_repository_web.dart' as _i36;
...
import '../domain/entity/specialist_work_info/specialist_work_info.dart'
    as _i42;
import '../domain/entity/user_model/user_model.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i2.FutureOr<void> init(_i1.GetItHelper gh) {
    ...
    gh.factory<_i11.Factory<_i12.UserModelDto, _i13.UserModel>>(
      () => _i14.PatientUserToDto(),
      registerFor: {_native},
    );
    gh.factory<
            _i15.Factory<_i16.SpecialistWorkInfo, _i16.SpecialistWorkInfoDto>>(
        () => _i17.SpecialistWorkInfoFromDto());
    gh.factory<_i15.Factory<_i18.User, Map<String, dynamic>>>(
        () => _i19.ChatUserDataFromMap());
    gh.factory<_i15.Factory<_i20.UserPresence, _i21.UserPresenceDto>>(
        () => _i22.UserPresenceFromDto());
    gh.factory<_i15.Factory<Map<String, dynamic>, _i16.UserModelDto>>(
        () => _i23.ModifiedUserDtoToMap());
    gh.factory<
            _i15.Factory<_i24.NotificationModel?, _i25.NotificationModelDto>>(
        () => _i26.NotificationModelFromDto());
    gh.factory<_i15.Factory<_i18.User, _i16.UserModelDto>>(
        () => _i27.UserModelDtoToChatUserMap());
    gh.factory<_i11.Factory<_i12.UserModelDto, _i13.UserModel>>(
      () => _i14.UserModelToDto(),
      registerFor: {_web},
    );
    gh.factory<_i11.Factory<_i28.SpecialistModelDto, _i29.SpecialistModel>>(
    ...
    gh.lazySingleton<_i47.FirebaseUserRepository>(
      () => _i47.FirebaseNativeUserRepository(
        ...
        gh<_i15.Factory<Map<String, dynamic>, _i16.UserModelDto>>(),
      ),
      registerFor: {_native},
    );
    gh.lazySingleton<_i47.FirebaseUserRepository>(
    ...
    gh.lazySingleton<_i64.UserController<_i13.PatientUser?>>(
      () => _i64.UserControllerNative(),
      registerFor: {_native},
    );
    gh.lazySingleton<_i64.UserController<_i13.UserModel?>>(
    ...
    gh.factory<_i67.AppNotificationsBloc<_i13.UserModel?>>(
        () => _i67.AppNotificationsBlocBase(
              gh<_i48.GetAppNotificationStreamUseCase>(),
              gh<_i64.UserController<_i13.UserModel?>>(),
            ));
    gh.factory<_i67.AppNotificationsBlocPatient>(
      () => _i67.AppNotificationsBlocPatient(
        gh<_i48.GetAppNotificationStreamUseCase>(),
        gh<_i64.UserController<_i13.PatientUser?>>(),
      ),
      registerFor: {_native},
    );
    gh.factory<_i68.ChatBloc<_i16.UserModel?>>(() => _i68.ChatBlocBasic(
          gh<_i64.UserController<_i16.UserModel?>>(),
    ...
    gh.factory<_i68.ChatBlocPatient>(
      () => _i68.ChatBlocPatient(
        gh<_i64.UserController<_i16.PatientUser?>>(),
        gh<_i50.GetMessagesUseCase>(),
        gh<_i9.CreateChatRoomUseCase>(),
        gh<_i59.SendMessageUseCase>(),
        gh<_i10.DeleteMessageUseCase>(),
    ...
    gh.factory<_i69.ChatRoomBloc<_i16.UserModel?>>(() => _i69.ChatRoomBlocBasic(
          gh<_i31.FetchChatRoomListUseCase>(),
          gh<_i70.UserController<_i16.UserModel?>>(),
        ));
    gh.factory<_i69.ChatRoomBlocPatient>(
      () => _i69.ChatRoomBlocPatient(
        gh<_i31.FetchChatRoomListUseCase>(),
        gh<_i70.UserController<_i16.PatientUser?>>(),
      ),
      registerFor: {_native},
    );
    gh.factory<
            _i11.Factory<_i2.Future<_i29.SpecialistModel>,
                _i28.SpecialistModelDto>>(
        () => _i71.SpecialistModelFromDto(gh<_i62.StorageService>()));
    gh.factory<_i11.Factory<_i2.Future<_i13.UserModel>, _i12.UserModelDto>>(
      () => _i72.UserModelFromDto(gh<_i62.StorageService>()),
      registerFor: {_web},
    );
    gh.factory<_i11.Factory<_i2.Future<_i13.UserModel>, _i12.UserModelDto>>(
      () => _i72.PatientUserFromDto(gh<_i62.StorageService>()),
      registerFor: {_native},
    );
    ...
    gh.lazySingleton<_i75.FirebaseChatRepository>(
        () => _i75.FirebaseChatRepository(
              gh<_i32.FirebaseInitializer>(),
              gh<_i15.Factory<_i18.User, Map<String, dynamic>>>(),
            ));
    ...
    gh.factory<_i78.FirebaseUserService>(() => _i78.FirebaseUserService(
          ...
          gh<_i32.StorageService>(),
          gh<_i15.Factory<_i2.Future<_i16.UserModel>, _i16.UserModelDto>>(),
          gh<_i15.Factory<_i16.UserModelDto, _i16.UserModel>>(),
          gh<_i15.Factory<_i16.UserPresence, _i21.UserPresenceDto>>(),
        ));
